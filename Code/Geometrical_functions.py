...
FLOAT_DIFFERENCE_FOR_EQUALITY = Parameters.FLOAT_DIFFERENCE_FOR_EQUALITY
...
def Vector_average(Vector_list):
    if len(Vector_list) == 0:
        ...
        return sum(list(Vector_i[0] for Vector_i in Vector_list)) / len(Vector_list), sum(
            list(Vector_i[1] for Vector_i in Vector_list)) / len(Vector_list)
...
def Distinct_points_3(Point_1, Point_2, Point_3):
    return Distinct_points_2(Point_1, Point_2) and Distinct_points_2(Point_1, Point_3) and Distinct_points_2(Point_2,
                                                                                                             Point_3)


# Check that 4 points are distinct
def Distinct_points_4(Point_1, Point_2, Point_3, Point_4):
    return Distinct_points_3(Point_1, Point_2, Point_3) and Distinct_points_2(Point_1, Point_4) and Distinct_points_2(
        Point_2, Point_4) and Distinct_points_2(Point_3, Point_4)
...
def Segment_to_circle_intersection(Point_1, Point_2, Circle_center, Circle_radius):
    if Float_eq_2d(Point_1, Point_2):
        return Distance_2d(Point_1, Circle_center) < Circle_radius
    else:
        ...
        if abs(Circle_center_new[1]) < Circle_radius:
            if 0 < Circle_center_new[0] < Norm(Sub_vectors(Point_2, Point_1)):
                return True
            elif Norm(Circle_center_new) < Circle_radius or Norm(Sub_vectors(Circle_center, Point_2)) < Circle_radius:
                return True
            else:
                return False
        else:
...
def Point_on_segment(Point_3, Point_1, Point_2):
    ...
    Is_inside_range = Point_inside_Circle(Point_3, Center_2d(Point_1, Point_2), Distance_2d(Point_1, Point_2) / 2)
...
def Segment_to_segment_intersection(Point_1, Point_2, Point_3, Point_4):
    ...
    # if they do form lines, check if their intersection is on one of the two segments
        ...
        if Intersection is None:
            ...
            return Point_on_segment(Intersection, Point_1, Point_2) and Point_on_segment(Intersection, Point_3, Point_4)


# Check if segment 1 intersects segment 2 in an area close to it by some safety distance
def Segment_to_segment_intersection_with_safe_distance(Point_1, Point_2, Point_3, Point_4, Safety_distance):
    ...
    # if point 1 and point 2 do not form a line, check if they are inside the safety zone of segment 2
        ...
        return Segment_to_circle_intersection(Point_3, Point_4, Point_1, Safety_distance)
    # if point 3 and point 4 do not form a line, check if the first segment intersects their safety zone
    elif Float_eq_2d(Point_3, Point_4) and (not Float_eq_2d(Point_1, Point_2)):
        return Segment_to_circle_intersection(Point_1, Point_2, Point_3, Safety_distance)
    # if they do form lines, check if the segment 1 intersect the pill safety zone of the segment 2
        ...
        if Segment_to_circle_intersection(Point_1, Point_2, Point_3, Safety_distance):
            return True
        elif Segment_to_circle_intersection(Point_1, Point_2, Point_4, Safety_distance):
            return True
        # Check if Points 1 and 2 and not inside the safety zone of the segment
        elif Segment_to_circle_intersection(Point_3, Point_4, Point_1, Safety_distance):
            return True
        elif Segment_to_circle_intersection(Point_3, Point_4, Point_2, Safety_distance):
            return True
        else:
